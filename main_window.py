...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.verticalLayout_10 = QtWidgets.QVBoxLayout(self.params_tab)
        self.verticalLayout_10.setObjectName("verticalLayout_10")
        self.horizontalLayout_6 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_6.setObjectName("horizontalLayout_6")
        self.param_name_in = QtWidgets.QLineEdit(parent=self.params_tab)
        self.param_name_in.setObjectName("param_name_in")
        self.horizontalLayout_6.addWidget(self.param_name_in)
        self.param_value_in = QtWidgets.QLineEdit(parent=self.params_tab)
        self.param_value_in.setObjectName("param_value_in")
        self.horizontalLayout_6.addWidget(self.param_value_in)
        self.add_param = QtWidgets.QToolButton(parent=self.params_tab)
        self.add_param.setObjectName("add_param")
        self.horizontalLayout_6.addWidget(self.add_param)
        self.verticalLayout_10.addLayout(self.horizontalLayout_6)
        self.params_list = QtWidgets.QListWidget(parent=self.params_tab)
        self.params_list.setObjectName("params_list")
        self.verticalLayout_10.addWidget(self.params_list)
        self.tabWidget.addTab(self.params_tab, "")
        self.headers_tab = QtWidgets.QWidget()
        self.headers_tab.setObjectName("headers_tab")
        self.verticalLayout_9 = QtWidgets.QVBoxLayout(self.headers_tab)
        self.verticalLayout_9.setObjectName("verticalLayout_9")
        self.horizontalLayout_5 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_5.setObjectName("horizontalLayout_5")
        self.header_name_in = QtWidgets.QLineEdit(parent=self.headers_tab)
        self.header_name_in.setObjectName("header_name_in")
        self.horizontalLayout_5.addWidget(self.header_name_in)
        self.header_value_in = QtWidgets.QLineEdit(parent=self.headers_tab)
        self.header_value_in.setObjectName("header_value_in")
        self.horizontalLayout_5.addWidget(self.header_value_in)
        self.add_header = QtWidgets.QToolButton(parent=self.headers_tab)
        self.add_header.setObjectName("add_header")
        self.horizontalLayout_5.addWidget(self.add_header)
        self.verticalLayout_9.addLayout(self.horizontalLayout_5)
        self.headers_list = QtWidgets.QListWidget(parent=self.headers_tab)
        self.headers_list.setObjectName("headers_list")
        self.verticalLayout_9.addWidget(self.headers_list)
